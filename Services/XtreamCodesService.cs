...
namespace XtreamIPTV.Services
{
    public class XtreamCodesService : IIPTVService
    {
        ...
        public Task<IEnumerable<Movie>> GetSimiliarMovies(Movie? movie, System.Collections.ObjectModel.ObservableCollection<Movie> allMovies)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Series>> GetSimiliarSeries(Series? series, System.Collections.ObjectModel.ObservableCollection<Series> allSeries)
        {
            throw new NotImplementedException();
        }
    }
